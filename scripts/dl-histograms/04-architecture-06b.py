...
network1 = batch_normalization(conv_2d(network, 64, 1, activation='relu', regularizer="L2"))
network2 = batch_normalization(conv_2d(network, 64, 3, activation='relu', regularizer="L2"))
...
model.fit(X, Y, n_epoch=5, validation_set=(testX, testY), snapshot_step=10, snapshot_epoch=False, show_metric=True, run_id='white-bkg-6')
#epoch=4 => 98%
