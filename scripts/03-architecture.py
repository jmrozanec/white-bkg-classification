#TFLearn bug: https://github.com/tflearn/tflearn/issues/180
...
model.fit(X, Y, n_epoch=50, validation_set=(testX, testY), snapshot_step=100, snapshot_epoch=False, show_metric=True, run_id='white-bkg')
